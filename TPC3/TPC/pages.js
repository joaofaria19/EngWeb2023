...
<html>
    ...
    <body>
        <div class="w3-bar w3-teal  w3-xlarge"">
            ...
            <a href="http://localhost:7777/distsex" class="w3-bar-item w3-button" style="width:25%">Distribuição por sexo</a>
            <a href="http://localhost:7777/distsports" class="w3-bar-item w3-button" style="width:25%">Distribuição por desporto</a>
    ...
    <body>
        ...
        pagHTML += `
                <tr>
                    <td>Feminino</td>
                    <td>
                        <a href="http://localhost:7777/distsex/people">
        ...
        for(let i=0; i<mapDesporto.size;i++){
            pagHTML+=`
                <tr>
                    ...
                    <td>
                        <a href="http://localhost:7777/distsports/people">
